...
#
AD-IN-EXCL: ^((aasia|ääni|abihun|baani|ben-haanan|daan|ester|geehasi|guuni|
  ...
  suu|vahinko|vaimo|((seko)?viini)|villiaasi|vuotee|aasi)
  (POSS-SFX-V?CLT-SFX?)|
#
# 1 N-PRP: SG-GEN (-n):
...
# 5 N-COM: NOM & GEN (V-back, -n): 
  ...
  aasia|aasi|aasie|ääne|äänie|iho|ihana|uuni)
...
# 75 PRON:
  ...
  toista|toisessa|toiselta|toiseen|toiselta|toiselle|toisille|
  toisia|toisissa|toisilta|toisille|toisilta|toisilleen|
...
#
# Adpositions listed in the file fin.spec which 
# do not belong to the groups A and B:
...
# 167 POP-AMB: 
  ...
  (kesken(ikääni))|
  (palkkaansa(vaille))|
  (valtaansa (niitä) kohtaan)|
  (likellä (herraa meidän) jumalaamme)|
  (mukaani (en) miekkaani))|
#
#  (((herraa(ni|nsa))|(jumalaa(mme|ni|nne))|kunigasta|teitä) vastaan)|
#
...
#  vastaan|vastaamme|vastaammekin|vastaatte|vastaattekin|
  ...
  (niin)|
  ((ottaa|ota|oteta|ottanutottaneet||otti|ottakaa|
  sen|minä) vastaan)|
#
