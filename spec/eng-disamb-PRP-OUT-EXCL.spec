...
# after
  ...
  (come (up|ye) after (him|me))|
  (cometh after (me|the|(the king)))|
  (cometh ((not forth)|up|one) after (me|saul))|
  ((and|i|that) come after)|
  ((draw|drew) after him)|
  ((fall|fled) after)|
  (((they follow)|((shall|will))) come after)|
  (that follow after as)|
  (follow after if that i may)|
  (followed after ((among them)|(and beheld)|crying|him|and))|
  ((gehazi|instruments|galilee|people|which) followed after)| 
...
# before
  ...
  (before (and|he|beware|(had shewed)))|
  (syrians before)|
  (before had seen)| 
...
#behind
  ...
  ((years|are|philistines|press|round) behind and)|
  (and behind (and|he))|
...
#beyond
  ...
  (went away again beyound jordan)|
#
# round
  (came round about me)|
