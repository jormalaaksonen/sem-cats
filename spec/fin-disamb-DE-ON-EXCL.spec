...
#  ((j‰lje|per‰|piele|syrj‰)st‰))(POSS-SFX?CLT-SFX?)|
#
# DE-ON: takaa as an particle modifying the verb "ajaa": 
  ((heit‰|h‰n|h‰nt‰|teit‰|minua|niit‰|meit‰|sinua|
  midianilaisia|vihollisia|tappajaa|filistealaisia|kuningasta|
  siiseraa|miehi‰|joosuaa|vihollisiani|abneria|jerobeamia|daavidia|
  vierasta|isi‰nne|
  aja|ajaa|ajan|ajanko|ajoi|ajoivat|ajanut|ajaneet|ajamasta|ajamaan|
  ajanko|ajamassa|
  filistealaiset|ja) takaa)(POSS-SFX?CLT-SFX?)|
#
# NEG-MOD-INF
#
# Adpositions containing the strings -lta/-lt‰, 
# but which do not belong to the groups C and D:
  (((puo(le)?)|suunna|taho|varre|varsi)lta)(POSS-SFX?CLT-SFX-B?)|
  ((keske|peri|sis‰|v‰li|ymp‰ri)lt‰)(POSS-SFX?CLT-SFX-F?))
# N‰m‰ palautettu takaisin 24.12.18
